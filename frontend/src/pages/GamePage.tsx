...
export function GamePage() {
  ...
  return <section className={`game-page theme-${round.theme.toLowerCase()}`}>
    <div className="game-heading"><div><p className="eyebrow">{gameName} · в полёте</p><h1>Навстречу высоте.</h1></div><span className="game-route">{round.theme} / {round.levels} уровней</span></div>
