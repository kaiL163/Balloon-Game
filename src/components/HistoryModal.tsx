...
const HISTORY_NOTE =
  'Ваши завершённые раунды сохранены на этом устройстве. В конце списка — 6 примеров, не влияющих на баланс. Выигрыш включает ставку. «—» означает, что cashout не было.';
