...
const rules: { title?: string; description: string }[] = [
  ...
  { title: 'Booster — усилитель', description: 'При любой ставке на маршруте появится сундук с бустером: без бустера, ×2, ×3 или ×4. Его содержимое откроется при достижении уровня: коэффициент умножится на бустер, а вы получите 20 × бустер очков. Сумма ставки не влияет на бустер. При раннем cashout сундук будет пропущен.' },
