...
const rules: { title?: string; description: string }[] = [
  ...
  { title: 'Booster — усилитель', description: 'Для x2/x3/x4 на маршруте появится бустер. Достигните его до cashout: текущий коэффициент умножится на booster, а вы получите ещё 20 × booster очков. При раннем cashout бустер будет пропущен. Для x1 бустера нет.' },
  ...
  { description: '«Забрать» доступно после первого уровня. После cashout выигрыш фиксируется, а шар продолжает лететь и набирать очки до crash. Все бонусы и награды виртуальные.' },
];
